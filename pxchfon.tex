...
\usepackage{shortvrb}
\MakeShortVerb{\|}
\newcommand{\PkgVersion}{0.7c}
\newcommand{\PkgDate}{2013/06/16}
...
\Note 0.7c版で\textbf{試験的に}中国語・韓国語フォントに
対するサポートを行った。
...
%===========================================================
\section{中国語・韓国語フォントへの対応（試験的）}
\label{sec:Non-Japanese}

0.7c版で試験的に\Pkg{OTF}パッケージ（|multi| オプション指定）および
