...
\usepackage{shortvrb}
\MakeShortVerb{\|}
\newcommand{\PkgVersion}{1.8}
\newcommand{\PkgDate}{2021/02/22}
...
\item |\setkoreangothicfont[|\Meta{番号}|]{|\Meta{フォントファイル名}|}|\Means
      韓国語・ゴシック体・単ウェイト。
\item |\setkoreanlightminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      韓国語・明朝体・細ウェイト。
\item |\setkoreanmediumminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      韓国語・明朝体・中ウェイト。
\item |\setkoreanboldminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      韓国語・明朝体・太ウェイト。
\item |\setkoreanmediumgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      韓国語・ゴシック体・中ウェイト。
\item |\setkoreanboldgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      韓国語・ゴシック体・太ウェイト。
\item |\setkoreanxboldgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      韓国語・ゴシック体・極太ウェイト。
\item |\setkoreanmarugothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      韓国語・丸ゴシック体。
...
\item |\setschinesegothicfont[|\Meta{番号}|]{|\Meta{フォントファイル名}|}|\Means
      簡体字中国語・ゴシック体（黒体）・単ウェイト。
\item |\setschineselightminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      簡体字中国語・明朝体（宋体）・細ウェイト。
\item |\setschinesemediumminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      簡体字中国語・明朝体（宋体）・中ウェイト。
\item |\setschineseboldminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      簡体字中国語・明朝体（宋体）・太ウェイト。
\item |\setschinesemediumgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      簡体字中国語・ゴシック体（黒体）・中ウェイト。
\item |\setschineseboldgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      簡体字中国語・ゴシック体（黒体）・太ウェイト。
\item |\setschinesexboldgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      簡体字中国語・ゴシック体（黒体）・極太ウェイト。
\item |\setschinesegothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      簡体字中国語・丸ゴシック体。
...
\item |\settchinesegothicfont[|\Meta{番号}|]{|\Meta{フォントファイル名}|}|\Means
      繁体字中国語・ゴシック体（黒体）・単ウェイト。
\item |\settchineselightminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      繁体字中国語・明朝体（明体）・細ウェイト。
\item |\settchineseboldminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      繁体字中国語・明朝体（明体）・中ウェイト。
\item |\settchinesexboldminchofont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      繁体字中国語・明朝体（明体）・太ウェイト。
\item |\settchinesemediumgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      繁体字中国語・ゴシック体（黒体）・中ウェイト。
\item |\settchineseboldgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      繁体字中国語・ゴシック体（黒体）・太ウェイト。
\item |\settchinesexboldgothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      繁体字中国語・ゴシック体（黒体）・極太ウェイト。
\item |\settchinesegothicfont[|\Meta{番号}|]{|%
      \Meta{フォントファイル名}|}|\Means
      繁体字中国語・丸ゴシック体。
\end{itemize}
